...
FRA: DVG und DVD als diverse nicht gematched, was machen wir mit denen? (aktuell independent)
...
ministerparty <- m_to_link$party[4] %>% str_remove_all(pattern = stop_pattern)
